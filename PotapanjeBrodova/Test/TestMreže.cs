...
namespace Test
{
    ...
    public class TestMreže
    {
        ...
        [TestMethod]
        public void Mreža_DajNizoveSlobodnihPoljaDoPoljaVraćačetiriNizaZaPoljeUSredini()
        {
            Mreža mreža = new Mreža(5, 5);

            var polja = mreža.DajNizSlobodnihPolja(new Polje(2, 2), Smjer.Desno);
            Assert.AreEqual(2, polja.Count());
            Assert.AreEqual(new Polje(2, 3), polja.First());
        }

        [TestMethod]
        public void Mreža_DajNizoveSlobodnihPoljaVraćaDvaPoljaLijevo()
        {
            Mreža mreža = new Mreža(5, 5);

            var polja = mreža.DajNizSlobodnihPolja(new Polje(2, 2), Smjer.Lijevo);
            Assert.AreEqual(2, polja.Count());
            Assert.AreEqual(new Polje(2, 1), polja.First());
        }

        [TestMethod]
        public void Mreža_DajNizoveSlobodnihPoljaVraćaDvaPoljaDolje()
        {
            Mreža mreža = new Mreža(5, 5);

            var polja = mreža.DajNizSlobodnihPolja(new Polje(2, 2), Smjer.Dolje);
            Assert.AreEqual(2, polja.Count());
        ...
        [TestMethod]
        public void Mreža_DajNizoveSlobodnihPoljaVraćaDvaPoljaGore()
        {
            Mreža mreža = new Mreža(5, 5);

            var polja = mreža.DajNizSlobodnihPolja(new Polje(2, 2), Smjer.Gore);
            Assert.AreEqual(2, polja.Count());
